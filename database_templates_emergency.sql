...
CREATE INDEX IF NOT EXISTS idx_personalized_tips_template ON personalized_tips(source_template_id);
CREATE INDEX IF NOT EXISTS idx_personalized_tips_disabled ON personalized_tips(is_disabled);
